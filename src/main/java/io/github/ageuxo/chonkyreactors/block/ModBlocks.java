...
import io.github.ageuxo.chonkyreactors.block.custom.ReactorSubBlock;
...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> REACTOR_SUB_BLOCK = registerBlock("reactor_sub_block", ()-> new ReactorSubBlock(BlockBehaviour.Properties.of().mapColor(MapColor.METAL).instrument(NoteBlockInstrument.IRON_XYLOPHONE).requiresCorrectToolForDrops().strength(1.5F)));
